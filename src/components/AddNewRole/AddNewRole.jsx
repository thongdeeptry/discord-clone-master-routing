...
function getSteps() {
  return ['Bắt đầu thêm vai trò', 'Thêm loại vai trò', 'Thêm vai trò'];
}
            ...
            <DialogContent className={classes.dialogcontent}>
              <DialogContentText className={classes.header}>
                  ...
                  <div className="addmorediv">
                    <Button onClick={handleaddanotherrole} className={classes.anotherrole} color='primary' variant='contained'>Thêm vai trò khác với cùng loại danh mục?</Button>
                    <Button onClick={handlefinishedrole} className={classes.finishedanotherrole} color='primary' variant='contained'>Hoàn thành thêm nhiều hơn</Button>
                  </div>
          ...
          <div>
            ...
            <div>
              ...
              </Button>
              {
                ...
                Hoàn thành</Button> : <Button variant="contained" color="primary" onClick={handleNext}>
                {activeStep === steps.length - 1 ? 'Hoàn thành' : 'Kế tiếp'}
              </Button>) 
              }
            </div>
