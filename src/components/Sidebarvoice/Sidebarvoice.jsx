        ...
        <div className='sidebarvoice'>
            <div className="sidebarvoice__header">
                <div className="sidebarvoice__connect">
                    ...
                    <div className="sidebarvoice__connect-connected">Giọng nói được kết nối</div>
                </div>
            ...
            <div className="sidebarvoice__stream">
                ...
                <div className="sidebarvoice__stream-screen">
                    <Button variant="text" className={classes.button} startIcon={ <ScreenShareIcon/>}>Chiếu</Button>
                </div>
            </div>
        </div>
    )
