    ...
    <div className='ChangeServername'>
            ...
            <DialogContentText component={'div'}className={classes.header}>
                    ...
                    <Typography component={'span'} className={classes.header__text}>
                        Thay đổi tên và biểu tượng máy chủ của bạn...
                    </Typography>
                ...
                <input type="text" placeholder='Thay đổi tên máy chủ' required className='input__content' autoFocus onChange={(e)=>setformValue(e.target.value)} value={formValue}/>
            </DialogContent>
            <DialogActions className={classes.dialogaction}>
            <button type='text' onClick={handleClose} className='ChangeServername__form-back'>Quay lại</button>
                <form onSubmit={handleSubmit} className='ChangeServername__form'>
                    <button type='submit' className='ChangeServername__form-button'>Thay đổi</button>
                </form>
            </DialogActions>
    </div>
    )
