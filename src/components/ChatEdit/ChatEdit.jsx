        ...
        <>
            <form onSubmit={handleSubmit}>
                ...
                <div className="editinstruction">
                    <p className='editinstruction__p'>Ấn ESC để thoát <span className='editinstruction__span' onClick={()=>dispatch(setclicked())}>Hủy bỏ</span> • Án Enter để <span className='editinstruction__span' onClick={handleSubmit}>save</span></p>
                </div>
            </form>
        </>
    )
