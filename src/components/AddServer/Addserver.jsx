        ...
        <Dialog open={open} onClose={handleClose} aria-labelledby="form-dialog-title" classes={{ paper: classes.paper}} >
            ...
            <DialogContentText component='div' className={classes.header}>
                    ...
                    <Typography component={'span'} className={classes.header__text}>
                        Đặt cho máy chủ mới của bạn một tính cách với một tên và một biểu tượng.
                    </Typography>
                    <Typography component={'span'} className={classes.header__text}>
                        Bạn luôn có thể thay đổi nó sau.
                    </Typography>
            ...
            <button type='text' onClick={handleClose} className='addserver__form-back'>Quay lại</button>
                <form onSubmit={handleSubmit} className='addserver__form'>
                    <button type='submit' onClick={handleClose} className='addserver__form-button'>Tạo</button>
                </form>
            </DialogActions>
        </Dialog>
    </div>
